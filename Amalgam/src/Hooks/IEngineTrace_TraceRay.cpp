...
// Only hook TraceRay when trace visualization is compiled in: the hook body is
// empty otherwise, and a detour on the hottest engine function (thousands of
// calls per tick from prediction / aimbot scans / movement sim, all inside
// CreateMove) is pure added input latency.
#ifdef DEBUG_TRACES
